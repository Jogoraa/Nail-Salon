-- Complete Capacity Setup for Existing Database Schema
-- This script adds ALL required columns and structure for the capacity management system
...
UPDATE services SET 
  ...
  default_start_time = COALESCE(default_start_time, '09:00'),
  default_end_time = COALESCE(default_end_time, '18:00'),
  slot_duration = COALESCE(slot_duration, 30),
...
GRANT EXECUTE ON FUNCTION can_book_service_simple TO authenticated;
GRANT EXECUTE ON FUNCTION get_available_times_simple TO authenticated;
